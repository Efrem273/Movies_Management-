...
<a class="active" href="new2.php">Mealtawi</a>
...
$date1=date("d",time());
$sql_query= "INSERT INTO  new2
values('".$name."','".$date."','".$date1."','".$part."')";
...
<h1><p>Write Name Of The Movie:<input type="text" name="photo"><p></h1>
	<h1><p>Part:<input type="text" name="photo1"><p></h1>

<input type="hidden" name="form_submitted" value="1" /> 
<p><input type="submit" style="width:17%;font-size:25px;background-color: #4CAF50;color:white" value="Mealtawi"> </p><br>


<h2><p><a href="pnewupdate.php"><span style='color:red;'>UPDATE</span> </a></p></h2>


<h2><p><a href="dpnew2.php"><span style='color:red;'>DELETE_One_by_One</span> </a></p></h2>


<h2><p><a href="dnew2.php"><span style='color:red;'>DELETE_ALL</span> </a></p></h2>

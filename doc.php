...
<a  class="active"  href="doc.php">Documentary</a>
...
if(isset($_POST["form_submitted"])){
 foreach ($_FILES['photo']['tmp_name'] as $key => $tmp_name) {
  ...
  move_uploaded_file($_FILES['photo']['tmp_name'][$key],'Documentary/'.$_FILES['photo']['name'][$key]);
...
<h1><p>Upload Documentary Poster: <br><input type="file" name="photo[]" multiple></p></h1>
<input type="hidden" name="form_submitted" value="1" /> 
<p><input type="submit" style="width:23%;font-size:25px;background-color: #4CAF50;color:white" value="Documentary"> </p><br><br><br><br>
<h2><p><a href="dpdoc.php"><span style='color:red;'>DELETE_One_by_One</span> </a></p></h2><br>


<h2><p><a href="ddoc.php"><span style='color:red;'>DELETE_ALL</span> </a></p></h2>

...
<a class="active" href="kor_s.php">Korea_Series</a>
...
if(isset($_POST["form_submitted"])){
  ...
  move_uploaded_file($_FILES['photo']['tmp_name'][$key],'Korea_Series/'.$_FILES['photo']['name'][$key]);
...
<h1><p>Upload Korea_Series Poster: <br><input type="file" name="photo[]" multiple></p></h1>
<input type="hidden" name="form_submitted" value="1" /> 
<p><input type="submit" style="width:32%;font-size:25px;background-color: #4CAF50;color:white" value="Korea_Series" > </p><br><br><br><br>

<h2><p><a href="dpkor_s.php"><span style='color:red;'>DELETE_One_by_One</span> </a></p></h2><br>


<h2><p><a href="dkor_s.php"><span style='color:red;'>DELETE_ALL</span> </a></p></h2>

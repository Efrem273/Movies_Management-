...
<a  class="active" href="tig_s.php">Tigrina_Series</a>
...
if(isset($_POST["form_submitted"])){
  ...
  move_uploaded_file($_FILES['photo']['tmp_name'][$key],'Tigrina_Series/'.$_FILES['photo']['name'][$key]);
...
<h1><p>Upload Tigrina_Series Poster: <br><input type="file" name="photo[]" multiple></p></h1>
<input type="hidden" name="form_submitted" value="1" /> 
<p><input type="submit" style="width:32%;font-size:25px;background-color: #4CAF50;color:white" value="Tigrina_Series"> </p><br><br><br><br>

<h2><p><a href="dptig_s.php"><span style='color:red;'>DELETE_One_by_One</span> </a></p></h2><br>


<h2><p><a href="dtig_s.php"><span style='color:red;'>DELETE_ALL</span> </a></p></h2>

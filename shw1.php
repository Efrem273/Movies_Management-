...
<a class="active" href="shw1.php">Tigrina_Show</a>
...
if(isset($_POST["form_submitted"])){
 foreach ($_FILES['photo']['tmp_name'] as $key => $tmp_name) {
  ...
  move_uploaded_file($_FILES['photo']['tmp_name'][$key],'Show/'.$_FILES['photo']['name'][$key]);
...
<h1><p>Upload Show Poster: <br><input type="file" name="photo[]" multiple></p></h1>
<input type="hidden" name="form_submitted" value="1" /> 
<p><input type="submit" style="width:17%;font-size:25px;background-color: #4CAF50;color:white" value="Show"></p> <br><br><br><br>

<h2><p><a href="dpshw.php"><span style='color:red;'>DELETE_One_by_One</span> </a></p></h2><br>


<h2><p><a href="dshw.php"><span style='color:red;'>DELETE_ALL</span> </a></p></h2>

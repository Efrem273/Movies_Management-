...
<a class="active"  href="kana.php">Kana</a>
...
if(isset($_POST["form_submitted"])){
  ...
  move_uploaded_file($_FILES['photo']['tmp_name'][$key],'Kana/'.$_FILES['photo']['name'][$key]);
...
<h1><p>Upload Kana Poster: <br><input type="file" name="photo[]" multiple><p></h1>
<input type="hidden" name="form_submitted" value="1" /> 
<p><input type="submit" style="width:17%;font-size:25px;background-color: #4CAF50;color:white" value="Kana"> </p><br><br><br><br>

<h2><p><a href="dpkana.php"><span style='color:red;'>DELETE_One_by_One</span> </a></p></h2><br>


<h2><p><a href="dkana.php"><span style='color:red;'>DELETE_ALL</span> </a></p></h2>

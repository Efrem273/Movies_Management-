...
<a href="shw1.php">Tigrina_Show</a>
...
<a class="active"  href="ani.php">Animation</a>
...
<img src="image/bachach.PNG" width="200px" height="400px"></div>
...
if(isset($_POST["form_submitted"])){
 foreach ($_FILES['photo']['tmp_name'] as $key => $tmp_name) {
  ...
  move_uploaded_file($_FILES['photo']['tmp_name'][$key],'Animation/'.$_FILES['photo']['name'][$key]);
...
<h1><p>Upload Animation Poster: <br><input type="file" name="photo[]" multiple></p></h1>
<input type="hidden" name="form_submitted" value="1" /> 
<p><input type="submit" style="width:23%;font-size:25px;background-color: #4CAF50;color:white" value="Animation"> </p><br><br><br><br>

<h2><p><a href="dpani.php"><span style='color:red;'>DELETE_One_by_One</span> </a></p></h2><br>


<h2><p><a href="dani.php"><span style='color:red;'>DELETE_ALL</span> </a></p></h2>

...
$sql_query= "SELECT * FROM shw ORDER BY `date` DESC";
...
while ($row=mysqli_fetch_array($x)) {
     $container=array();
	echo'(<img src="Show/'.$row[0].'"  width="900px" hieght="900px"/>)';
	array_push($container,'<a href="dshw1.php?bdate='.$row[0].'" style="background:#A63322;color:white">DELETE</a>');

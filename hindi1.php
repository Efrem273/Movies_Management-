...
<a class="active"  href="hindi1.php">Hindi</a>
...
if(isset($_POST["form_submitted"])){
  ...
  move_uploaded_file($_FILES['photo']['tmp_name'][$key],'Hindi/'.$_FILES['photo']['name'][$key]);
...
<h1><p>Upload Hindi Poster: <br><input type="file" name="photo[]" multiple></p></h1>

<input type="hidden" name="form_submitted" value="1" /> 
<p><input type="submit" style="width:17%;font-size:25px;background-color: #4CAF50;color:white" value="Hindi"></p> <br><br><br><br>

<h2><p><a href="dphindi.php"><span style='color:red;'>DELETE_One_by_One</span> </a></p></h2><br>


<h2><p><a href="dhindi.php"><span style='color:red;'>DELETE_ALL</span> </a></p></h2>

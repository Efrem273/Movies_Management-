...
<a class="active"  href="tur1.php">Turkey</a>
...
if(isset($_POST["form_submitted"])){
  ...
  move_uploaded_file($_FILES['photo']['tmp_name'][$key],'Turkey/'.$_FILES['photo']['name'][$key]);
...
<h1><p>Upload Turkey Poster: <br><input type="file" name="photo[]" multiple></p></h1>
<input type="hidden" name="form_submitted" value="1" /> 
<p><input type="submit" style="width:17%;font-size:25px;background-color: #4CAF50;color:white" value="Turkey"> </p><br><br><br><br>

<h2><p><a href="dptur.php"><span style='color:red;'>DELETE_One_by_One</span> </a></p></h2><br>


<h2><p><a href="dtur.php"><span style='color:red;'>DELETE_ALL</span> </a></p></h2>

...
<a class="active"  href="msc.php">Music_Clip</a>
...
if(isset($_POST["form_submitted"])){
  ...
  move_uploaded_file($_FILES['photo']['tmp_name'][$key],'Music_Clip/'.$_FILES['photo']['name'][$key]);
...
<h1><p>Upload Music_Clip Poster: <br><input type="file" name="photo[]" multiple><p></h1>
<input type="hidden" name="form_submitted" value="1" /> 
<p><input type="submit" style="width:26%;font-size:25px;background-color: #4CAF50;color:white" value="Music_Clip"> </p><br><br><br><br>

<h2><p><a href="dpmsc.php"><span style='color:red;'>DELETE_One_by_One</span> </a></p></h2><br>


<h2><p><a href="dmsc.php"><span style='color:red;'>DELETE_ALL</span> </a></p></h2>

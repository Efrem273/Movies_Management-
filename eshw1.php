...
<a class="active" href="eshw1.php">English_Show</a>
</div>
<!-- Center part -->
...
foreach ($_FILES['photo']['tmp_name'] as $key => $tmp_name) {
  ...
  move_uploaded_file($_FILES['photo']['tmp_name'][$key],'Eshow/'.$_FILES['photo']['name'][$key]);
...
<h1><p>Upload English_Show Poster: <br><input type="file" name="photo[]" multiple><p></h1>
<input type="hidden" name="form_submitted" value="1" /> 
<p><input type="submit" style="width:27%;font-size:25px;background-color: #4CAF50;color:white" value="English_Show"> </p><br><br><br><br>

<h2><p><a href="dpeshw.php"><span style='color:red;'>DELETE_One_by_One</span> </a></p></h2><br>


<h2><p><a href="deshw.php"><span style='color:red;'>DELETE_ALL</span> </a></p></h2>

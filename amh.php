...
<a  class="active"  href="amh.php">Amharic</a>
...
foreach ($_FILES['photo']['tmp_name'] as $key => $tmp_name) {
  ...
  move_uploaded_file($_FILES['photo']['tmp_name'][$key],'Amharic/'.$_FILES['photo']['name'][$key]);
...
<p><input type="submit" style="width:17%;font-size:25px;background-color: #4CAF50;color:white" value="Amharic"> </p><br><br><br><br>

<h2><p><a href="dpamh.php"><span style='color:red;'>DELETE_One_by_One</span> </a></p></h2><br>


<h2><p><a href="damh.php"><span style='color:red;'>DELETE_ALL</span> </a></p></h2>
</form>
